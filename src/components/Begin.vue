<template>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="night-hotel">GET START</div>
                <!-- TODO 添加文件到本地 -->
...
<script>
//  import 'http://use.edgefonts.net/carter-one.js';
export default {
  name: "Begin",
  props: {
    //对外获取的数据
...
.night-hotel {
  ...
  text-shadow: 0 0 10px rgb(255, 255, 255), 0 0 20px rgb(255, 255, 255),
    0 0 30px rgb(255, 255, 255), 0 0 40px rgb(255, 17, 119),
    0 0 70px rgb(255, 17, 119), 0 0 80px rgb(255, 17, 119),
    0 0 100px rgb(255, 17, 119), 0 0 150px rgb(255, 17, 119);
...
.night-hotel:hover {
  text-shadow: 0 0 5px rgb(255, 255, 255), 0 0 10px rgb(255, 255, 255),
    0 0 15px rgb(255, 255, 255), 0 0 20px rgb(255, 17, 119),
    0 0 35px rgb(255, 17, 119), 0 0 40px rgb(255, 17, 119),
    0 0 50px rgb(255, 17, 119), 0 0 75px rgb(255, 17, 119);
}
</style>