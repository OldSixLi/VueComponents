...
<div class="col-md-6">
  <panel title="日期组件">
    ...
    <p class="text-muted" slot="footer">
      <b>注:</b>此处利用第一个ht-date的值(timepicker)为基础,第二个ht-date组件中prop属性'min-date'的值设置为timepicker,而'max-date'值通过Vue computed属性进行实时计算,在timepicker的基础上加7天
    </p>
  </panel>
  <panel title="分页组件">
  ...
  <panel title="动画效果" style="background-color: #ddd;">
    ...
    <info-block img-src="http://om6fr85l4.bkt.clouddn.com/zhou.jpg" title="周杰伦" intro="歌手,演员" word="对这个世界如果你有太多的抱怨跌倒了 就不敢继续往前走为什么 人要这么的脆弱 堕落请你打开电视看看 多少人为生命在努力勇敢的走下去我们是不是该知足珍惜一切 就算没有拥有还记得你说家是唯一的城堡随着稻香河流继续奔跑微微笑 小时候的梦我知道不要哭让萤火虫带着你逃跑乡间的歌谣永远的依靠回家吧 回到最初的美好" style="width:32%;"></info-block>
...
<div role="tabpanel" class="tab-pane active" id="messages">
  ...
  <panel title="技能展示">
    <skill imgsrc="http://om6fr85l4.bkt.clouddn.com/square3.jpg?imageView2/0/q/58|imageslim" title="HTML">
      <ul class="lists">
        <li>精通HTML5完成页面构建</li>
        <li>语义化标签</li>
