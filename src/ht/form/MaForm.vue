  ...
  export default {
    ...
    mounted: function () {
      ...
      this.$children.forEach(function (child) {
        child.$options._componentTag == "ma-form-group" && this.htFormItemLength++;
      }, this);
    ...
    methods: {
      checkItem(callback) {
        ...
        this.broadcast("MaFormGroup", "validate", this.infoType);
        this.checkResultList = [];
        this.errorMessageList = [];
      },
      //清除校验
      clearValidate: function () {
        this.broadcast("MaFormGroup", "clearValidate");
        this.checkResultList = [];
        this.errorMessageList = [];
      }
    }
