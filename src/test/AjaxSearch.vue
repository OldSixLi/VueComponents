<template>
  <div class="input-group">
    <!-- //输入框部分 -->
    <input type="text" class="form-control" :value="currentValue" @input="handleInput" @focus="handleInput" @keypress.enter="searchClick"
      :placeholder="placeholder" ref="inputs">
    <!-- @blur="blurFn" 失去焦点时如何处理-->
    <!-- //AJAX部分 -->
    <transition name="panel">
      <div class="resultPanel" :style="{'width':'50%'}" style="position:absolute;left:0;top:110%;background-color:#fff;box-shadow:0 0 7px 2px rgba(38,28,28,0.2);border-radius: 4px;"
        v-show="((resultList&&resultList.length)||(authorList&&authorList.length))&&isFocus">
        <ul style="padding:0;">
